...
def MyPredict(new_loc):
    ...
    weights = gp._gp_weights(locations=locations, current_location=new_loc, cholesky=cholesky)
    var = gp._gp_variance(locations=locations, current_location=new_loc, cholesky=cholesky)
